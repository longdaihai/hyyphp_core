...
class Cache
{
    ...
    public static function connect(array $options = [], $name = false)
    {
        ...
        if (true === $name || !isset(self::$instance[$name])) {
            ...
            '\\hyyphp\\lib\\cache\\driver\\' . ucwords($type) :
            $type;
    ...
    public static function init(array $options = [])
    {
        if (is_null(self::$handler)) {
            ...
            $options = Config::get('config', 'cache');
    ...
    {
        $cache = Config::get('config', 'cache');
        if ('' !== $name && 'complex' == $cache['type']) {
            return self::connect($cache[$name], strtolower($name));
        }
