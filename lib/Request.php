...
class Request
{
    ...
    public function pathinfo()
    {
        if (is_null($this->pathinfo)) {
            if (isset($_GET[Config::get('config', 'var_pathinfo')])) {
                // 判断URL里面是否有兼容模式参数
                $_SERVER['PATH_INFO'] = $_GET[Config::get('config', 'var_pathinfo')];
                unset($_GET[Config::get('config', 'var_pathinfo')]);
            } elseif (IS_CLI) {
            ...
            if (!isset($_SERVER['PATH_INFO'])) {
                foreach (Config::get('config', 'pathinfo_fetch') as $type) {
    ...
    public function method($method = false)
    {
        if (true === $method) {
            ...
            if (isset($_POST[Config::get('config', 'var_method')])) {
                $this->method = strtoupper($_POST[Config::get('config', 'var_method')]);
    ...
    public function isSsl()
    {
        ...
        if (isset($server['HTTPS']) && ('1' == $server['HTTPS'] || 'on' == strtolower($server['HTTPS']))) {
            ...
            return true;
        } elseif (Config::get('config', 'https_agent_name') && isset($server[Config::get('config', 'https_agent_name')])) {
            return true;
        }
        return false;
    }
    ...
    public function isAjax($ajax = false)
    {
        ...
        if (true === $ajax) {
            ...
            $result =  $this->param(Config::get('config', 'var_ajax')) ? true : $result;
    ...
    public function isPjax($pjax = false)
    {
        ...
        if (true === $pjax) {
            ...
            $result = $this->param(Config::get('config', 'var_pjax')) ? true : $result;
            $this->mergeParam = false;
            return $result;
        }
    }
    ...
    public function ip($type = 0, $adv = true)
    {
        ...
        $httpAgentIp = Config::get('config', 'http_agent_ip');
